  ...
  return (
    <PageWrapper narrow>
      <StaticPageHeader
        ...
        title="نصائح وإهداء"
        subtitle="نصايح وتوجيهات للجداد وشكر خاص للمساهمين في الدليل"
        category="life"
      />

      <div style={{ marginBottom: "36px" }}>
        <Alert title="مرحبا بيكم في إيزات زغوان" variant="success">
          الدليل هذا معمول بالكامل باش يعاونكم تبداو خطواتكم الأولى في الحياة الجامعية براحة وثقة. هاذوما أهم النصايح من طلبة مروا بنفس تجربتكم!
        </Alert>
      </div>
          ...
          <div style={{ display: "flex", flexDirection: "column", alignItems: "center", textAlign: "center", gap: "16px" }}>
            ...
            <div style={{ width: "100%" }}>
              ...
              <p style={{ fontSize: "14px", color: "var(--color-text-secondary)", lineHeight: 1.7, maxWidth: "580px", margin: "0 auto 20px" }}>
                نحبّو نهديو الدليل هذا لكل طالب وطالبة يسعوا لتحقيق طموحاتهم. شكر من القلب لكل واحد ساهم بوقتو ومعلوماتو وخبرتو باش نخرّجو بالعمل المزيان هذا:
              </p>
              <div
                style={{
