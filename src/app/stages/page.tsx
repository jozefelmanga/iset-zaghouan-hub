...
import { internships, internshipDocs, internshipTips, dsegExampleReports, stagePresentationLogos } from "@/data/internships";
          ...
          {internships.map((internship, i) => {
            ...
            return (
              <MotionReveal key={internship.year} delay={i * 0.12}>
                <div style={{ background: colors.bg, border: `1px solid ${colors.border}`, borderRadius: "20px", padding: "24px" }}>
