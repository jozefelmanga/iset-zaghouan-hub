...
export function GPRPageContent() {
  ...
  return (
    <>
      ...
      <details style={{ marginBottom: "40px", padding: "20px", borderRadius: "12px", background: "rgba(34, 197, 94, 0.05)", border: "1px solid rgba(34, 197, 94, 0.2)", cursor: "pointer" }}>
        <summary style={{ fontSize: "18px", fontWeight: 700, color: "var(--color-primary)", display: "flex", flexWrap: "wrap", alignItems: "center", justifyContent: "space-between", gap: "12px", outline: "none", userSelect: "none" }}>
          ...
          <span style={{ fontSize: "13px", fontWeight: 600, color: "var(--color-primary)", background: "rgba(34, 197, 94, 0.1)", padding: "6px 12px", borderRadius: "8px", whiteSpace: "nowrap", marginTop: "auto" }}>اضغط للتفاصيل 🔽</span>
        </summary>
        <div style={{ marginTop: "16px", cursor: "default" }}>
          <p style={{ fontSize: "14.5px", color: "var(--color-text-secondary)", lineHeight: 1.6, marginBottom: "16px" }}>
            نعلمكم أنه تم تحديث المسارات (Parcours) في قسم هندسة الأساليب! السنة الأولى ستبقى جذعاً مشتركاً (Tronc Commun)، وابتداءً من السنة الثانية يمكنكم الاختيار من بين 3 مسارات جديدة:
            <strong> Génie des Procédés Chimiques, Génie des Procédés Alimentaires, و Génie des Procédés Pharmaceutiques.</strong>
          </p>
