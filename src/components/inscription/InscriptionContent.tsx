...
import { Card, Alert, Badge, ImageGallery } from "@/components/ui/shared";
import { enrollmentSteps, enrollmentPhases, enrollmentDocs } from "@/data/enrollment";
import { enrollmentStepIcons } from "@/lib/iconMaps";
    ...
    <>
      ...
      >
        <Card elevation="feature" padding="28px">
          ...
          <div style={{ height: "8px", background: "var(--color-border)", borderRadius: "999px", overflow: "hidden", marginBottom: "12px" }}>
            <motion.div
              style={{
                height: "100%",
      ...
      <div style={{ marginBottom: "40px" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
          {enrollmentSteps.map((step, i) => {
            const Icon = enrollmentStepIcons[step.icon] || FileText;
