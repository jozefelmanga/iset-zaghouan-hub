export const generalTips = [
  ...
  "رد بالك تغيب في المواد الأساسية اللي فيها كور، خاطر المعلومات اللي يعطوهم مهمين وهما الأساس. وزيد ديما دوكيمونت ناقص، وترسيمك يكون مع أصحابك باش يعطوك حاجة تطبعها.",
...
export const restoTips = [
  ...
  "إذا نسيت الجتون، تنجم تاكل ببطاقة الخدمات الجامعية اللي يعطوهالك نهار اللي ترسم في الفوايي، وتستعمل بيها في الرستو.",
