export const departmentList = [
  {
    ...
    description: "قسم الإعلامية وهو من أكثر الأقسام طلباً، يركّز على تكوين كفاءات في البرمجة، هندسة البرمجيات، والشبكات السيبرانية.",
    icon: "code",
    color: "#3B82F6",
  ...
  },
  {
    ...
    description: "يهتمّ بالمالية والمحاسبة وإدارة الأعمال، باش يخرّج إطارات يخدمو في الشركات والمصانع ومراقبة الجودة.",
    icon: "coins",
    color: "#8B5CF6",
  ...
  },
  {
    ...
    description: "قسم هندسة العمليات يخرّج فنيين سامين في المراقبة والتحاليل المخبرية للمنتجات الكيميائية والغذائية.",
    icon: "flask",
    color: "#12B8C8",
