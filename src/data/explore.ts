export const exploreZaghouan = {
  ...
  mountainGuide: {
    name: "فهد بلغيث",
    role: "مرشد سياحي — جبل زغوان",
    avatar: "/images/fahd-belghith.webp",
    phone: "+21623605218",
    phoneDisplay: "23 605 218",
    instagram: "https://www.instagram.com/fahdbelghith?igsh=c25vY3phZmpkeDI0",
    instagramHandle: "@fahdbelghith",
  },
  youtubeVideo: {
    title: "Discover Zaghouan Mountain 🇹🇳",
    embedUrl: "https://www.youtube.com/embed/9ijcK7iK8rU",
  },
};

export const zaghouanGallery = [
